...
int main(int argc, char** argv, char** env) {
    ...
    #pragma omp parallel shared(numbers, size, minimum, maximum, value_difference, bucket_element_counts, timestamps, buckets, bucket_locks, bucket_count, BUCKET_RANGE) default(none)
    {
